...
1.1. Настоящее Пользовательское соглашение (далее — «Соглашение») регулирует отношения между создателями Telegram-бота (далее — «Бот», «Сервис», «Администрация») и любым лицом, использующим данного Бота (далее — «Пользователь»).
1.2. Нажатие кнопки «/start», а также любое использование функций Бота означает безоговорочное согласие Пользователя с условиями настоящего Соглашения.
1.3. Если Пользователь не согласен с условиями данного Соглашения, он обязан немедленно прекратить использование Бота.

<b>2. Описание сервиса</b>
2.1. Бот предоставляет Пользователям доступ к своему внутреннему функционалу, базе данных и сопутствующим развлекательно-информационным возможностям.
2.2. Бот предоставляется по принципу «как есть» (as is). Администрация не гарантирует бесперебойную работу Бота, отсутствие ошибок и не несет ответственности за временные технические сбои.

<b>3. Права и обязанности сторон</b>
<b>3.1. Пользователь обязуется:</b>
- Не использовать Бота для спама, флуда и применения автоматизированных скриптов, создающих избыточную нагрузку на Сервис.
- Не пытаться взломать, декомпилировать, использовать уязвимости или иным образом нарушить нормальную работу Бота.
- Уважительно относиться к Администрации и службе поддержки.

<b>3.2. Администрация имеет право:</b>
- Ограничить или полностью заблокировать доступ Пользователя к Боту (выдать перманентный бан) без предварительного уведомления и без объяснения причин в случае нарушения настоящего Соглашения или подозрительной активности.
- Вносить изменения в функционал Бота, добавлять или удалять возможности по своему усмотрению без уведомления Пользователей.

<b>4. Платные услуги и политика возвратов (Strict No Refund Policy)</b>
4.1. В Боте могут быть предусмотрены платные услуги (подписки, разовые покупки и т.д.). Оплата производится через интегрированные платежные системы.
4.2. Администрация не хранит и не обрабатывает платежные данные (номера карт, CVC-коды и т.д.).
4.3. <b>Возврат средств не осуществляется ни при каких обстоятельствах.</b> Оплачивая любые услуги в Боте, Пользователь признает, что приобретает цифровой товар/услугу, и добровольно отказывается от права требовать возврата денежных средств.
4.4. В случае непредвиденных технических сбоев на стороне Сервиса, Администрация оставляет за собой право (но не обязанность) компенсировать Пользователю время простоя путем продления подписки на соответствующий срок. Денежный эквивалент компенсации не выплачивается.
4.5. В случае блокировки Пользователя (бана) за нарушение правил Соглашения, доступ к платным функциям аннулируется, а средства за неиспользованный период подписки или неиспользованные услуги <b>не возвращаются</b>.

<b>5. Отказ от ответственности</b>
5.1. Администрация не несет ответственности за любой прямой или косвенный ущерб, упущенную выгоду или потерю данных, возникшие в результате использования или невозможности использования Бота.
5.2. Вся ответственность за любые действия, совершенные с использованием Бота, полностью лежит на Пользователе.

<b>6. Конфиденциальность (Privacy Policy)</b>
6.1. Для обеспечения работы Сервиса Бот собирает минимально необходимые данные Пользователя, предоставляемые платформой Telegram (Telegram ID, имя пользователя, выбранный язык).
6.2. Собранные данные используются исключительно для внутренней аналитики, сохранения настроек профиля и корректного предоставления платных услуг.
6.3. Администрация обязуется не передавать данные Пользователей третьим лицам, за исключением случаев, прямо предусмотренных законодательством.
...
<b>8. Контакты</b>
8.1. Служба поддержки: https://t.me/Kusaira_anime?direct
"""
...
async def cmd_start(message: Message, session: AsyncSession, state: FSMContext):
    ...
    if not user.has_accepted_tos:
        ...
        await message.answer(TOS_TEXT, reply_markup=keyboard, parse_mode="HTML")
        return
