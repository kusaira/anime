...
4.4. <b>Чарджбэки (Chargebacks):</b> При попытке принудительного возврата средств через банк, аккаунт Пользователя перманентно блокируется, а данные передаются в платежную систему для оспаривания.
4.5. В случае блокировки Пользователя (в том числе по усмотрению Администрации или за слив контента), доступ к платным функциям аннулируется, а <b>средства не возвращаются</b>.
...
5.3. <b>Форс-мажор:</b> Администрация не несет ответственности за перебои в работе Бота, вызванные причинами, не зависящими от Сервиса (сбои серверов Telegram, блокировки провайдеров, обстоятельства непреодолимой силы).
...
6.3. <b>Право на удаление:</b> Пользователь имеет право запросить полное удаление своих данных, обратившись в службу поддержки. При этом оказание услуг и доступ к Боту прекращаются.
